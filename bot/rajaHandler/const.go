...
const (
	StartMsg = "خوش آمدید!" + "\n" +
		"ساعت های دردسترس نبودن سایت رجا:" + "\n" +
		"00:00 -> 00:15" + "\n" +
		"06:30 -> 06:45" + "\n" +
		"13:30 -> 13:45" + "\n" +
		"19:30 -> 19:45" + "\n" +
		"چنل اطلاع رسانی: @SeyedBots"
	SelectTypeMsg    = "سامانه را انتخاب کنید: (قطار های قم به بخش حومه ای منتقل شده اند، جهت اطلاعات بیشتر عضو چنل @SeyedBots شوید)"
	NormalRajaBtn    = "سامانه رجا"
	HomeiBtn         = "سامانه حومه ای گردشگری"
	ThrdAppBtn       = "سامانه های شخص ثالث"
	SrcMsg           = "لطفا ایستگاه مبدا را انتخاب کنید"
	DstMsg           = "لطفا ایستگاه مقصد را انتخاب کنید"
	SelectRouteMSg   = "لطفا مسیر را انتخاب کنید"
	...
	PageN            = "صفحه %d"
	FavSign          = " " + "⭐️"
	AnError          = "خطای ناشناخته، لطفا با ادمین ارتباط بگیرید"
	DayMsg           = "لطفا تاریخ را انتخاب کنید" + "\n" + "MMM yyyy"
	...
	CancelMsg        = "دستور کنسل را فرستاده و مجددا تلاش کنید."
	successfulCreate = "درخواست با موفقیت ثبت شد"
	LimitReached     = "شما اجازه ثبت درخواست فعال بیشتر از این را ندارید. در صورت تمایل به افزایش محدودیت با ادمین ارتباط بگیرید."
	RajaErr          = "خطا در رجا"
